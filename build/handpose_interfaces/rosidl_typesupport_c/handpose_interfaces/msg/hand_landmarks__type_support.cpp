...
static const _HandLandmarks_type_support_symbol_names_t _HandLandmarks_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, handpose_interfaces, msg, HandLandmarks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, handpose_interfaces, msg, HandLandmarks)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, handpose_interfaces, msg, HandLandmarks)() {
  return &::handpose_interfaces::msg::rosidl_typesupport_c::HandLandmarks_message_type_support_handle;
}

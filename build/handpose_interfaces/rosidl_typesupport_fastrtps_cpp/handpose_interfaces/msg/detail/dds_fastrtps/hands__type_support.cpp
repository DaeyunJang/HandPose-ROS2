...
#include "handpose_interfaces/msg/detail/hands__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const handpose_interfaces::msg::HandLandmarks &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const handpose_interfaces::msg::Hands & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: hands
  {
    ...
    for (size_t i = 0; i < size; i++) {
      handpose_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.hands[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  handpose_interfaces::msg::Hands & ros_message)
{
  // Member: header
  ...
  // Member: hands
  {
    ...
    for (size_t i = 0; i < size; i++) {
      handpose_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: hands
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        handpose_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: hands
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        handpose_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_HandLandmarks(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = handpose_interfaces::msg::Hands;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const handpose_interfaces::msg::Hands *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<handpose_interfaces::msg::Hands *>(
    untyped_ros_message);
...
{
  return &handpose_interfaces::msg::typesupport_fastrtps_cpp::_Hands__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, handpose_interfaces, msg, Hands)() {
  return &handpose_interfaces::msg::typesupport_fastrtps_cpp::_Hands__handle;
}
